...
function useMutationObserver(callback, options) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useMutationObserver.useCallback": (node)=>{
            if (observer.current) {
            ...
            return ({
                "useMutationObserver.useCallback": ()=>{
                    if (observer.current) {
                        observer.current.disconnect();
                        observer.current = null;
                    }
...
function useMutationObserverTarget(callback, options, target) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useMutationObserverTarget.useEffect": ()=>{
            if (observer.current) {
                observer.current.disconnect();
                observer.current = null;
            }
        ...
        "useMediaQuery.useEffect": ()=>{
            try {
                if ("matchMedia" in window) {
                    ...
                    const callback = {
                        "useMediaQuery.useEffect.callback": (event)=>setMatches(event.matches)
                    }["useMediaQuery.useEffect.callback"];
...
"[project]/node_modules/@mantine/hooks/esm/use-long-press/use-long-press.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useLongPress(onLongPress, options = {}) {
    ...
    const isLongPressActive = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    const isPressed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    ...
    const startPosition = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useLongPress.useEffect": ()=>({
                "useLongPress.useEffect": ()=>window.clearTimeout(timeout.current)
            })["useLongPress.useEffect"]
    }["useLongPress.useEffect"], []);
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useLongPress.useMemo": ()=>{
            ...
            const move = {
                "useLongPress.useMemo.move": (event)=>{
...
function useFocusTrap(active = true) {
    ...
    const focusNode = (node)=>{
        ...
        if (!focusElement) {
            ...
            if (!focusElement && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mantine$2f$hooks$2f$esm$2f$use$2d$focus$2d$trap$2f$tabbable$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["focusable"])(node)) focusElement = node;
        }
        ...
        "useFocusTrap.useEffect": ()=>{
            ...
            const handleKeyDown = {
                "useFocusTrap.useEffect.handleKeyDown": (event)=>{
                    if (event.key === "Tab" && ref.current) (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mantine$2f$hooks$2f$esm$2f$use$2d$focus$2d$trap$2f$scope$2d$tab$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["scopeTab"])(ref.current, event);
                }
...
function useFocusReturn({ opened, shouldReturnFocus = true }) {
    ...
    const returnFocus = ()=>{
        if (lastActiveElement.current && "focus" in lastActiveElement.current && typeof lastActiveElement.current.focus === "function") lastActiveElement.current?.focus({
            preventScroll: true
        });
    };
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mantine$2f$hooks$2f$esm$2f$use$2d$did$2d$update$2f$use$2d$did$2d$update$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDidUpdate"])({
        "useFocusReturn.useDidUpdate": ()=>{
            ...
            if (opened) lastActiveElement.current = document.activeElement;
                ...
                }["useFocusReturn.useDidUpdate"], 10);
            }
            return ({
                "useFocusReturn.useDidUpdate": ()=>{
...
function useClickOutside(callback, events, nodes, enabled = true) {
    ...
    const listener = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffectEvent"])({
        "useClickOutside.useEffectEvent[listener]": (event)=>{
            const { target } = event ?? {};
            if (!document.body.contains(target) && target?.tagName !== "HTML") return;
            const path = event.composedPath();
            if (Array.isArray(nodes)) nodes.every({
                "useClickOutside.useEffectEvent[listener]": (node)=>!!node && !path.includes(node)
            }["useClickOutside.useEffectEvent[listener]"]) && callback(event);
            else if (ref.current && !path.includes(ref.current)) callback(event);
        }
    }["useClickOutside.useEffectEvent[listener]"]);
...
function useId$1(staticId) {
    const [uuid, setUuid] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(`mantine-${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useId"])().replace(/:/g, "")}`);
...
//# sourceMappingURL=node_modules_0_m4hjk._.js.map